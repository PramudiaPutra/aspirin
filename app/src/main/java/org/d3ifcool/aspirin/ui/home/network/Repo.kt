...
class Repo {
    ...
    fun getPostingData():LiveData<MutableList<PostingData>>{
        ...
        var database = FirebaseDatabase.getInstance("https://aspirin-aspirasi-indonesia-default-rtdb.asia-southeast1.firebasedatabase.app").reference.child("postingan")
